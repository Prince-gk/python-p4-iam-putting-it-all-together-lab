...
class TestSignup:
    ...
    def test_creates_users_at_signup(self):
        ...
        with app.test_client() as client:
            ...
            assert (
                new_user.image_url
                == "https://cdn.vox-cdn.com/thumbor/I3GEucLDPT6sRdISXmY_Yh8IzDw=/0x0:1920x1080/1820x1024/filters:focal(960x540:961x541)/cdn.vox-cdn.com/uploads/chorus_asset/file/24185682/Ash_Ketchum_World_Champion_Screenshot_4.jpg"
            )
            assert (
                new_user.bio
...
class TestRecipeIndex:
    ...
    def test_creates_recipes_with_201(self):
        ...
        with app.test_client() as client:
            ...
            assert (
                response_json["minutes_to_complete"] == new_recipe.minutes_to_complete
            )
